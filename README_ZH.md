...
| 方法 | 任务 | 思路(来自论文 §3.5) | Paper | Code |
| --- | --- | --- | --- | --- |
| MAP-Net (Xu et al., 2023) | 视频去雾 | 物理先验建模 + 多范围时间对齐(记忆式物理先验引导模块 + 多范围场景辐射恢复模块) | [Paper](https://arxiv.org/abs/2303.09757) | [Code](https://github.com/jiaqixuac/MAP-Net) |
| SemiVDN (Wu et al., 2024) | 视频去雪 | 半监督;分布驱动对比正则化 + 先验引导的时间解耦专家模块;引入 85 段真实雪景视频 | [Paper](https://arxiv.org/abs/2410.07901) | [Code](https://github.com/TonyHongtaoWu/SemiVDN) |
| Wang et al. (2023b) | 视频去雨 | 无监督、事件相机辅助框架:非对称分离、跨模态融合与跨模态对比学习 | [Paper](https://openaccess.thecvf.com/content/ICCV2023/papers/Wang_Unsupervised_Video_Deraining_with_An_Event_Camera_ICCV_2023_paper.pdf) | [Code](https://github.com/booker-max/Unsupervised-Deraining-with-Event-Camera) |
...
- **MIRNet** [Paper](https://arxiv.org/abs/2003.06792) [Code](https://github.com/swz30/MIRNet) (Zamir et al., 2020) 与 **MIRNetv2** [Paper](https://arxiv.org/abs/2205.01649) [Code](https://github.com/swz30/MIRNetv2) (Zamir et al., 2022b) — 多尺度残差设计以增强特征学习。
- **DGUNet** [Paper](https://arxiv.org/abs/2204.13348) [Code](https://github.com/MC-E/Deep-Generalized-Unfolding-Networks-for-Image-Restoration) (Mou et al., 2022) — 将优化过程展开为可学习的阶段。
- **NAFNet** [Paper](https://arxiv.org/abs/2204.04676) [Code](https://github.com/megvii-research/NAFNet) (Chen et al., 2022a) — 简化恢复架构以提升效率。
- **BIDeN** [Paper](https://arxiv.org/abs/2108.11364) [Code](https://github.com/JunlinHan/BID) (Han et al., 2022) — 基于分解的灵活恢复策略。
- **AMIRNet** [Paper](https://arxiv.org/abs/2308.03021) [Code](https://github.com/Justones/AMIRNet) (Zhang et al., 2023a) — 层次化退化先验。
- **SwinIR** [Paper](https://arxiv.org/abs/2108.10257) [Code](https://github.com/jingyunliang/swinir) (Liang et al., 2021) — 移位窗口建模局部-全局依赖。
- **Fourmer** [Paper](https://proceedings.mlr.press/v202/zhou23f.html) [Code](https://github.com/manman1995/Fourmer) (Zhou et al., 2023) — 4D 特征交互。
- **AutoDIR** [Paper](https://arxiv.org/abs/2310.10123) [Code](https://github.com/jiangyitong/AutoDIR) (Jiang et al., 2024) — 用扩散先验推断并适应退化类型。
- **Perceive-IR** [Paper](https://arxiv.org/abs/2408.15994) [Code](https://github.com/House-yuyu/Perceive-IR) (Zhang et al., 2025a) — 主干无关的 AiO 框架,通过质量感知 prompt 学习联合建模退化类型与程度。
- **UniUIR** [Paper](https://arxiv.org/abs/2501.12981) [Code](https://github.com/House-yuyu/UniUIR) (Zhang et al., 2025b) — 将统一恢复视为 all-in-one 学习器(IEEE TIP;见论文 §4.3 末尾)。
